...
public abstract class ConfigurationLoader {
    public static final String ENV_CONFIGURATION_LOADER = "UNISONHT_CONFIGURATION_LOADER";
    ...
    public static Class getConfigurationLoaderByName(String configLoaderName) {
        ...
        try {
            ...
            throw new UnisonhtException("Could not load class " + configLoaderName, e);
        }
        return configLoader;
    }
    ...
    private static ConfigurationLoader getOrCreateConfigurationLoader(Class configLoaderClass, Map initParameters) {
        ...
        try {
            ...
            throw new UnisonhtException("Could not load configuration class: " + configLoaderClass.getName(), e);
        }
        return configurationLoader;
    }
    ...
    protected void doConfigureLog4j() {
        ...
        UnisonhtLogger logger = UnisonhtLoggerFactory.getLogger(UnisonhtLoggerFactory.class);
