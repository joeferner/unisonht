...
public class BenqProjectorDevice extends Device {
    private static final UnisonhtLogger LOGGER = UnisonhtLoggerFactory.getLogger(BenqProjectorDevice.class);
    private final String address;
    private final Map<String, String> inputMapping;

    public BenqProjectorDevice(String address, Map<String, String> inputMapping) {
